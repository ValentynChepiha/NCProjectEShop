...
@Repository
public class OrderProductRepository implements ModelRepository<OrderProduct> {
    ...
    public OrderProduct getOne(long id) {
        ...
        OrderProduct orderProduct =  jdbcTemplate.queryForObject(sql, new OrderProductMapper(), id);
        return orderProduct;
    }
}
